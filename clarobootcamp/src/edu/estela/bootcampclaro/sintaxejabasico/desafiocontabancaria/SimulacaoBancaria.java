package edu.estela.bootcampclaro.sintaxejabasico.desafiocontabancaria;
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (true) {
                ...
                switch (opcao) {
                    // TODO: Implemente as condições necessárias para avalia a opcao escolhida:
